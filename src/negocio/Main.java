...
public class Main {
	...
	public static void main(String[] args) {
		// criando algumas contas e clientes fictícios
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Ana Coutinho", 28, "anacout@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Laura Sofia", 20, "lauras@gmail.com", conta02.getId(), true);
